...
if getattr(sys, 'frozen', False):
    ...
    def show_splash_instantly():
        ...
        try:
            ...
            tk.Label(splash_root, text="Open Clank", font=("Segoe UI", 22, "bold"), bg="#1a1c23", fg="#e06c75").pack(pady=(22, 2))
...
def setup_system_tray(url):
    try:
        ...
        menu = (
            pystray.MenuItem('Open Clank', lambda icon, item: on_open_browser(icon, item, url), default=True),
